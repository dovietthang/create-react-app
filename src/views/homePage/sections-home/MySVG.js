...
const MySVG = () => {
  ...
  return (
    <div className="smooth-transition-loader mimic-ajax">
      <div className="st-loader">
        <div className="st-loader1">
          <div className="dor-preloader">
            <svg x="0px" y="0px" width="400px" height="120px" viewBox="0 0 360 100" enableBackground="new 0 0 277.667 119.667">
              <path
                className="letter-1"
                fill="none"
                stroke="#FFFFFF"
              ...
              <line
                ...
                y2="7.7"
              />
              <path className="letter-2" fill="none" stroke="#FFFFFF" strokeWidth="4" strokeMiterlimit="10" d="M296,48.2h48" />
              <line
                className="line-3"
                fill="none"
                stroke="#FFFFFF"
